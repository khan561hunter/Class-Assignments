...
export default function Navbar(){
    return(
        <main>
            <div className=" sm:w-[390px] sm:h-[34px] lg:w-[1440px]    lg:h-[38px]  bg-[black] flex items-center">
                <div className=" w-[351px] sm:w-[301px] sm:h-[16px]  h-[19px]    lg:absolute  lg:top-[9px] lg:left-[544px]">
                    ...
                    <Image className=" sm:hidden lg:block md:block w-[20px] h-[20px] absolute top-[9px] left-[776px] my-[-8px]" src={cross} alt="cross"></Image>
                </div>
            </div>
            <div className=" lg:w-[1240px] sm:w-[390px]   lg:h-[48px] sm:h-[46px]  lg:absolute  lg:top-[62px]  lg:left-[50px] lg:flex sm:flex sm:items-center sm:justify-between lg:items-center lg:justify-between gap-[40px]  ">
                ...
                <Image className="sm:w-[126px] sm:h-[18px] sm:absolute lg:absolute sm:top-[57px] sm:left-[56px] lg:w-[160px] lg:top-[13px]  lg:h-[22px]  lg:mx-[30px]" src={logo} alt="logo"></Image>
                <Image className="sm:block lg:hidden lg:w-[96px] lg:h-[24px] sm:absolute sm:top-[56px] sm:left-[278px]"  src={frame2} alt="frame"></Image>
                <Image className=" sm:hidden lg:block  w-[321px] h-[22px] absolute left-[265px]" src={navbar} alt="navbar"></Image>
