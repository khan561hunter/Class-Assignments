...
import Four from "../page-04/page-04";

export default function Three(){
    return(
        <div className="w-[1440px] h-[2900px]  absolute top-[910px]" >
            <div>
                {/* first part of page 3 */}
            <div className="w-[403px] h-[58px] absolute top-[81px] left-[518px] ">
                <p className="text-black font-extrabold text-[48px] leading-[57.6px] text-center">NEW ARRIVALS</p>
                
            </div>
            <div>
                <Image className="w-[295px] h-[298px] absolute top-[194px] left-[100px] " src={pic1} alt="pic1"></Image>
                <div className="w-[225px] h-[27px] absolute top-[508px] left-[100px]"><p className="text-nowrap font-bold text-[20px] leading-[27px]">T-shirt with Tape Details</p></div>
                <Image className="w-[150px] h-[19px] absolute top-[543px] left-[100px]" src={star1} alt="star"></Image>
                <div className="w-[55px] h-[32px] absolute top-[570px] left-[100px]"><p className="font-bold text-[24px] leading-[32.4px]">$120</p></div>
            </div>
            <div>
                <Image className="w-[295px] h-[298px] absolute top-[194px] left-[415px] " src={pic2} alt="pic1"></Image>
                <div className="w-[150px] h-[27px] absolute top-[508px] left-[415px]"><p className="text-nowrap font-bold text-[20px] leading-[27px]">Skinny Fit Jeans</p></div>
                <Image className="w-[126.2px] h-[19px] absolute top-[543px] left-[415px]" src={star2} alt="star"></Image>
                <div className="w-[200px] h-[32px] absolute top-[570px] left-[415px]"><Image src={price1} alt="price"></Image></div>
            </div>
            <div>
                <Image className="w-[295px] h-[298px] absolute top-[194px] left-[730px] " src={pic3} alt="pic1"></Image>
                <div className="w-[151px] h-[27px] absolute top-[508px] left-[730px]"><p className="text-nowrap font-bold text-[20px] leading-[27px]">Checkered Shirt</p></div>
                <Image className="w-[126.2px] h-[19px] absolute top-[543px] left-[730px]" src={star3} alt="star"></Image>
                <div className="w-[55px] h-[32px] absolute top-[570px] left-[730px]"><p className="font-bold text-[24px] leading-[32.4px]">$180</p></div>
            </div>
            <div>
                <Image className="w-[295px] h-[298px] absolute top-[194px] left-[1045px] " src={pic4} alt="pic1"></Image>
                <div className="w-[199px] h-[27px] absolute top-[508px] left-[1045px]"><p className="text-nowrap font-bold text-[20px] leading-[27px]">Sleeve Stripped T-shirt</p></div>
                <Image className="w-[126.2px] h-[19px] absolute top-[543px] left-[1045px]" src={star4} alt="star"></Image>
                <div className="w-[200px] h-[32px] absolute top-[570px] left-[1045px]"><Image src={price2} alt="price"></Image></div>
            </div>
            </div>
            <div className="w-[218px] h-[52px] absolute top-[638px] left-[611px]   rounded-[62px] border-[1px] border-[#0000001A]">
                <p className=" w-[58px] h-[22px] font-medium text-[16px]  px-[77px] py-[16px] leading-[21.6px] text-nowrap">View All</p>
            </div>
            <div className="w-[1240px] absolute top-[754px] left-[100px] border-[1px] bg-[#0000001A]"></div>
            ...
            <Image className="w-[295px] h-[298px] absolute top-[931px] left-[730px]" src={s_pic3} alt="pic"></Image>
                ...
                <div className="w-[113.09px] h-[19px] absolute top-[1280px] left-[730px]"><Image src={s_star3} alt="star"></Image></div>
